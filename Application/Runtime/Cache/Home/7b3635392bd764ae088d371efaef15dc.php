			...
			<div class="summary">
				...
				<div class="preview fl">
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<?php if(is_array($pic)): foreach($pic as $k=>$vo): ?><li class="<?php if(($k) == "0"): ?>cur<?php endif; ?>">
									<a class="<?php if(($k) == "0"): ?>zoomThumbActive<?php endif; ?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/<?php echo ($vo["goods_img"]); ?>',largeimage: '/<?php echo ($vo["goods_img"]); ?>'}"><img src="/<?php echo ($vo["goods_thumb"]); ?>"></a>
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="<?php echo U('Cart/addCart');?>" method="post" class="choose">
						<ul>
							<?php if(is_array($sigle)): foreach($sigle as $key=>$vo): ?><li class="product">
								<dl>
									<dt><?php echo ($vo["0"]["attr_name"]); ?>：</dt>
									<dd>
										<?php if(is_array($vo)): foreach($vo as $keys=>$v): ?><a <?php if(($keys) == "0"): ?>class="selected"<?php endif; ?> href="javascript:;"><?php echo ($v["attr_values"]); ?> <input type="radio" name="attr[<?php echo ($v["attr_id"]); ?>]" value="<?php echo ($v["id"]); ?>" <?php if(($keys) == "0"): ?>checked="checked"<?php endif; ?> /></a><?php endforeach; endif; ?>
									</dd>
								</dl>
							</li><?php endforeach; endif; ?>
							<li>
			...
			<div class="detail" id="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<?php if(is_array($unique)): foreach($unique as $key=>$vo): ?><li><span><?php echo ($vo["attr_name"]); ?>:</span><?php echo ($vo["attr_values"]); ?></li><?php endforeach; endif; ?>
							</ul>
						</div>
					...
					<div class="comment detail_div mt10">
						<div class="comment_summary">
							...
							<div class="buyer fl">
								<dl>
									<dt>买家印象：</dt>
									<?php if(is_array($buyer)): foreach($buyer as $key=>$vo): ?><dd><span><?php echo ($vo["name"]); ?></span><em>(<?php echo ($vo["count"]); ?>)</em></dd><?php endforeach; endif; ?>
								</dl>
							</div>
						</div>
						<?php if(is_array($comment["list"])): foreach($comment["list"] as $key=>$vo): ?><div class="comment_items mt10">
							<div class="user_pic">
								<dl>
							...
							<div class="item">
								...
								<div class="btns">
									...
									<a href="" data-id="<?php echo ($vo["id"]); ?>" class="useful">有用(<span><?php echo ($vo["good_number"]); ?></span>)</a>
								</div>
							</div>
							...
							<form action="<?php echo U('comment');?>" method="post">
								<ul>
									...
									<li>
										...
										<?php if(is_array($buyer)): foreach($buyer as $key=>$vo): ?><input type="checkbox" name="old[]" value="<?php echo ($vo["id"]); ?>" /><?php echo ($vo["name"]); ?>　<?php endforeach; endif; ?>
									</li>
									<li>

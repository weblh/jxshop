...
<body>
	...
	<div class="guide w1210 bc mt15">
		...
		<div class="guide_content fl">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						<?php if(is_array($crazy)): foreach($crazy as $key=>$vo): ?><li>
							<dl>
				...
				<div class="hot none">
					<ul>
						<?php if(is_array($hot)): foreach($hot as $key=>$vo): ?><li>
							<dl>
								<dt><a href="<?php echo U('Goods/index','goods_id='.$vo['id']);?>"><img src="/<?php echo ($vo["goods_img"]); ?>" alt="" /></a></dt>
								<dd><a href="<?php echo U('Goods/index','goods_id='.$vo['id']);?>"><?php echo ($vo["goods_name"]); ?></a></dd>
				...
				<div class="recommend none">
					<ul>
						<?php if(is_array($rec)): foreach($rec as $key=>$vo): ?><li>
							<dl>
								<dt><a href="<?php echo U('Goods/index','goods_id='.$vo['id']);?>"><img src="/<?php echo ($vo["goods_img"]); ?>" alt="" /></a></dt>
								<dd><a href="<?php echo U('Goods/index','goods_id='.$vo['id']);?>"><?php echo ($vo["goods_name"]); ?></a></dd>
								<dd><span>售价：</span><strong> ￥<?php echo ($vo["shop_price"]); ?></strong></dd>
	...
	<!--1F 电脑办公 start -->
	<?php if(is_array($floor)): foreach($floor as $key=>$vo): ?><div class="floor1 floor w1210 bc mt10">
		<!-- 1F 左侧 start -->
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					<ul>
						<?php if(is_array($vo["son"])): foreach($vo["son"] as $key=>$v): ?><li><a href="<?php echo U('Category/index','id='.$v['id']);?>"><b>.</b><?php echo ($v["cname"]); ?></a></li><?php endforeach; endif; ?>
					</ul>
			...
			<div class="goodslist fl">
				<h2>
					<?php if(is_array($vo["recson"])): foreach($vo["recson"] as $keys=>$v): ?><span <?php if(($keys) == "1"): ?>class="on"<?php endif; ?> ><?php echo ($v["cname"]); ?></span><?php endforeach; endif; ?>
				</h2>
				<div class="goodslist_wrap">
					<?php if(is_array($vo["recson"])): foreach($vo["recson"] as $keys=>$v): ?><div <?php if(($keys) != "1"): ?>class="none"<?php endif; ?> >
						<ul>
							<?php if(is_array($v["goods"])): foreach($v["goods"] as $key=>$v3): ?><li>
								<dl>
